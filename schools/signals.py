"""Storage cleanup signals for the schools app.

Mirrors `home.signals` / `about_us.signals` — when a model's FileField/
...
for every schools model that has at least one FileField/ImageField.
"""
