# Generated for the schools app — initial migration.
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('side_image', models.ImageField(blank=True, null=True, upload_to='schools/hero/', validators=[home.validators.validate_image_size, home.validators.validate_image_extension])),
            ],
            options={
