"""Copy direct image fields on events singletons into `SectionImage`
...
SECTIONS = [
    ("events", "EventsFeaturedSection", ["side_image"]),
    ("events", "EventsSubmitSection", ["side_image"]),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("events", "0008_submit_section"),
        ("data_management", "0006_section_image"),
    ]

    operations = [
        migrations.RunPython(copy_images_to_section_image, noop_reverse),
        migrations.RemoveField(model_name="eventsfeaturedsection", name="side_image"),
        migrations.RemoveField(model_name="eventssubmitsection", name="side_image"),
    ]
