"""Copy direct image fields on partners singletons into `SectionImage`
...
SECTIONS = [
    ("partners", "PartnersFounderSection", ["side_image"]),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("partners", "0010_founder_section_side_image"),
        ("data_management", "0006_section_image"),
    ]

    operations = [
        migrations.RunPython(copy_images_to_section_image, noop_reverse),
        migrations.RemoveField(model_name="partnersfoundersection", name="side_image"),
    ]
